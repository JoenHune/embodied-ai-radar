...
|---|---|---|---|---|
| [Demonstrating CropFollow++: Robust Under-Canopy Navigation with Keypoints](https://doi.org/10.15607/rss.2024.xx.023) | 2024-01-01 | RSS 2024、RSS 2024 | 是 | — |
...
| [Enter the Mind Palace: Reasoning and Planning for Long-term Active Embodied Question Answering](https://arxiv.org/abs/2507.12846) | 2025-07-17 | CoRL 2025 | 是 | — |
...
| [Towards Generalizable Safety in Crowd Navigation via Conformal Uncertainty Handling](https://arxiv.org/abs/2508.05634) | 2025-08-07 | CoRL 2025 | 是 | — |
...
| [VLM-Social-Nav: Socially Aware Robot Navigation Through Scoring Using Vision-Language Models](https://arxiv.org/abs/2404.00210) | — | RA-L 2025 | 否 | — |
...
| [Think, Act, and Ask: Open-World Interactive Personalized Robot Navigation](https://arxiv.org/abs/2310.07968) | — | ICRA 2024 | 否 | — |
...
| [Visual route following for tiny autonomous robots](https://www.science.org/doi/10.1126/scirobotics.adk0310) | 2024-07-17 | Science Robotics 2024 | 否 | — |
...
| [OpenIN: Open-Vocabulary Instance-Oriented Navigation in Dynamic Domestic Environments](https://arxiv.org/abs/2501.04279) | 2025-01-08 | RA-L 2025、ICRA 2026 | 否 | — |
...
| [What Matters for Active Texture Recognition With Vision-Based Tactile Sensors](https://arxiv.org/abs/2403.13701) | — | ICRA 2024 | 否 | — |
| [AutoNeRF: Training Implicit Scene Representations with Autonomous Agents](https://arxiv.org/abs/2304.11241) | — | IROS 2024 | 否 | — |
...
| [Interactive Continual Learning Architecture for Long-Term Personalization of Home Service Robots](https://arxiv.org/abs/2403.03462) | — | ICRA 2024 | 否 | — |
| [SICNav-Diffusion: Safe and Interactive Crowd Navigation with Diffusion Trajectory Predictions](https://arxiv.org/abs/2503.08858) | 2025-03-11 | RA-L 2025、ICRA 2026 | 否 | — |
...
| [Arena 4.0: A Comprehensive ROS2 Development and Benchmarking Platform for Human-centric Navigation Using Generative-Model-based Environment Generation](https://arxiv.org/abs/2409.12471) | 2024-09-19 | ICRA 2025 | 否 | — |
| [EfficientEQA: An Efficient Approach to Open-Vocabulary Embodied Question Answering](https://arxiv.org/abs/2410.20263) | 2024-10-26 | IROS 2025 | 否 | — |
| [VANP: Learning Where to See for Navigation with Self-Supervised Vision-Action Pre-Training](https://arxiv.org/abs/2403.08109) | — | IROS 2024 | 否 | — |
| [ForceSight: Text-Guided Mobile Manipulation with Visual-Force Goals](https://arxiv.org/abs/2309.12312) | — | ICRA 2024 | 否 | — |
| [HAMMER: Heterogeneous, Multi-Robot Semantic Gaussian Splatting](https://arxiv.org/abs/2501.14147) | 2025-01-24 | RA-L 2025 | 否 | — |
