...
> v2 层级：learning_and_infrastructure。当前 canonical works 857 条；此页是扩展分类试运行，不直接改写旧五类历史序列。
...
| [Long Range Navigator (LRN): Extending robot planning horizons beyond metric maps](https://arxiv.org/abs/2504.13149) | 2025-04-17 | CoRL 2025 | 是 | — |
...
| [RenderOcc: Vision-Centric 3D Occupancy Prediction with 2D Rendering Supervision](https://arxiv.org/abs/2309.09502) | — | ICRA 2024 | 否 | — |
| [RoboVQA: Multimodal Long-Horizon Reasoning for Robotics](https://arxiv.org/abs/2311.00899) | — | ICRA 2024 | 否 | — |
| [Talk2BEV: Language-enhanced Bird's-eye View Maps for Autonomous Driving](https://arxiv.org/abs/2310.02251) | — | ICRA 2024 | 否 | — |
...
| [SemGauss-SLAM: Dense Semantic Gaussian Splatting SLAM](https://arxiv.org/abs/2403.07494) | — | IROS 2025 | 否 | — |
...
| [NavFormer: A Transformer Architecture for Robot Target-Driven Navigation in Unknown and Dynamic Environments](https://arxiv.org/abs/2402.06838) | — | RA-L 2024 | 否 | — |
| [Dream2Real: Zero-Shot 3D Object Rearrangement with Vision-Language Models](https://arxiv.org/abs/2312.04533) | — | ICRA 2024 | 否 | — |
| [GAMMA: Generalizable Articulation Modeling and Manipulation for Articulated Objects](https://ieeexplore.ieee.org/document/10610652) | 2024-05-13 | ICRA 2024 | 否 | — |
...
| [Tactile Robotics: An Outlook](https://arxiv.org/abs/2508.11261) | 2025-08-15 | T-RO 2025 | 否 | — |
...
| [Proto-CLIP: Vision-Language Prototypical Network for Few-Shot Learning](https://arxiv.org/abs/2307.03073) | — | IROS 2024 | 否 | — |
...
| [MTG: Mapless Trajectory Generator with Traversability Coverage for Outdoor Navigation](https://arxiv.org/abs/2309.08214) | — | ICRA 2024 | 否 | — |
...
| [OpenGS-SLAM: Open-Set Dense Semantic SLAM with 3D Gaussian Splatting for Object-Level Scene Understanding](https://arxiv.org/abs/2503.01646) | — | ICRA 2025 | 否 | — |
...
| [SemanticFormer: Holistic and Semantic Traffic Scene Representation for Trajectory Prediction Using Knowledge Graphs](https://arxiv.org/abs/2404.19379) | — | RA-L 2024 | 否 | — |
| [Toward Grounded Commonsense Reasoning](https://arxiv.org/abs/2306.08651) | — | ICRA 2024 | 否 | — |
...
| [Translating Universal Scene Descriptions into Knowledge Graphs for Robotic Environment](https://arxiv.org/abs/2310.16737) | — | ICRA 2024 | 否 | — |
| [VISO-Grasp: Vision-Language Informed Spatial Object-centric 6-DoF Active View Planning and Grasping in Clutter and Invisibility](https://arxiv.org/abs/2503.12609) | 2025-03-16 | IROS 2025 | 否 | — |
| [CoPeD-Advancing Multi-Robot Collaborative Perception: A Comprehensive Dataset in Real-World Environments](https://arxiv.org/abs/2405.14731) | — | RA-L 2024 | 否 | — |
| [Marker or Markerless? Mode-Switchable Optical Tactile Sensing for Diverse Robot Tasks](https://arxiv.org/abs/2408.08276) | 2024-08-15 | RA-L 2024 | 否 | — |
| [“Don't Forget to Put the Milk Back!” Dataset for Enabling Embodied Agents to Detect Anomalous Situations](https://arxiv.org/abs/2404.08827) | — | RA-L 2024 | 否 | — |
