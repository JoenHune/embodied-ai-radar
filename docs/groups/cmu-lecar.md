...
| 日期待核 | 预印本 | [Blog](https://lecar-lab.github.io/blog.html) | 未严格同行评审 | G1 直接证据 | — | 官方来源页面新发现的链接，等待结构化归类。 |
...
| 来源 | URL | 状态 | 最近成功 | 连续失败 |
|---|---|---|---|---:|
| home | [https://www.ri.cmu.edu/robotics-groups/lecar-lab/](https://www.ri.cmu.edu/robotics-groups/lecar-lab/) | healthy | 2026-09-13 | 0 |
| publications | [https://lecar-lab.github.io/](https://lecar-lab.github.io/) | healthy | 2026-09-13 | 0 |
