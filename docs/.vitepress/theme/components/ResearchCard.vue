...
const usageLabels: Record<string, string> = { real_robot: '真机使用', simulated_robot: '仿真使用', training_compute: '训练算力', inference_compute: '推理算力', data_collection: '数据采集', sensing: '感知', dataset_source: '数据来源' }
