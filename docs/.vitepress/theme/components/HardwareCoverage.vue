...
const categoryLabels: Record<string, string> = { robot_platform: '人形与移动机器人', robot_arm: '机械臂', dexterous_hand: '灵巧手', gripper: '夹爪', compute_platform: '算力平台', data_collection: '数采与遥操作', tactile_sensor: '触觉传感器', force_sensor: '力与力矩传感器', vision_sensor: '视觉与空间传感器', inertial_sensor: '惯性传感器' }
