...
test('source rows render every work and usage with direct URL, locus and validation boundaries', () => {
  ...
  for (const field of ['usage.source_url', 'usage.source_locator', 'usage.validation_context', 'usage.usage_scope', 'source.title']) assert.ok(source.includes(field), field)
