...
const chunks = ['RadarDashboard', 'PeopleRadar', 'HardwareRadar', 'LocoManipRadar', 'DatabaseExplorer', 'PulseFeed', 'ConferenceRadar', 'OrganizationCoverage', 'ReportCoverage', 'VPLocalSearchBox', 'echarts', 'v3-overview', 'runtime-core.esm-bundler', 'app']
...
test('equipment routes load only their own component and shared charts', async () => {
  assert.deepEqual(await retained('hardware/index.md'), ['HardwareRadar', 'echarts', 'runtime-core.esm-bundler', 'app'])
